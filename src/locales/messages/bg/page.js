const messages = {
  ...
  categories: {
    ...
    description: 'Открий богатото културно наследство на България чрез разнообразната ѝ гама от забележителности. Разгледай нашия списък с категории, за да намериш следващото си приключение.',
  },
  contact: {
    title: 'Контакти',
  ...
  regions: {
    ...
    description: 'Намери твоята идеална дестинация за следващо пътуване из туристическите райони на България, предлагащи по нещо за всеки тип пътешественик.',
  },
  locality: {
    title: 'Община',
  },
