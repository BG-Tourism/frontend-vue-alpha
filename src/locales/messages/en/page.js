const messages = {
  ...
  contact: {
    ...
    form: {
      ...
      result: {
        ...
        error: 'An error occurred and your message was not sent.',
      },
      button: 'Send',
    },
  },
  ...
  homepage: {
    ...
    destinations: {
      title: 'Popular Tourist Regions',
      description: 'Visit iconic and unique sights that define the Bulgarian tourist regions\' culture and history',
      locations_count: '{count} locations in this region',
    },
  },
  place: {
    subtitle: 'Place',
    ...
    contents: {
      aiGenerated: 'The text is entirely generated by AI and may contain many errors. If you\'d like to fix it, you can do so via our <a href="{repo}" target="blank">GitHub repository</a>.',
