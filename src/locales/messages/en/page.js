const messages = {
    ...
    place: {
        ...
        contents: {
            aiGenerated:
                'The text is entirely generated by AI and may contain many errors. If you\'d like to fix it, you can do so via our <a href="{repo}" target="blank">GitHub repository</a>.',
            copyrights:
