...
const places = [
  ...
  },
  {
    ...
    markdown_content: {
      ...
      locale: {
        bg: '<h1>Заглавие</h1><p>text</p>',
        en: '<h1>Title</h1><p>text</p>',
      },
    },
    reviews: [
      {
